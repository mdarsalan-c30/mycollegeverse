                ...
                <div class="max-w-4xl mx-auto">
                    ...
                    <div x-show="currentStep === 0" class="space-y-8 animate-fade-in">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2"><label class="text-[10px] font-black uppercase tracking-widest text-slate-400">Professional Title</label><input x-model="resume.personal.role" class="w-full bg-white border-2 border-slate-100 rounded-2xl p-4 font-bold focus:border-primary focus:ring-0 transition-all"></div>
                ...
                <div class="flex items-center justify-between mb-8">
                    <div class="flex items-center gap-6">
                        ...
                        <div class="flex gap-2">
                            <button @click="loadTemplate('premium')" class="text-[10px] font-black uppercase px-3 py-1 bg-primary text-white rounded-lg hover:bg-primary-dark">Premium Professional</button>
    ...
    <script>
        function resumeBuilder() {
            return {
                ...
                loadTemplate(t) {
                    if(t === 'premium') this.latexCode = `\\documentclass[letterpaper,10pt]{article}\n\n\\usepackage{latexsym}\n\\usepackage[empty]{fullpage}\n\\usepackage{titlesec}\n\\usepackage{enumitem}\n\\usepackage[hidelinks]{hyperref}\n\\usepackage{fancyhdr}\n\\usepackage[english]{babel}\n\\usepackage{tabularx}\n\\usepackage{array}\n\\input{glyphtounicode}\n\\usepackage{fontawesome5}\n\\hypersetup{colorlinks=true, urlcolor=black}\n\n\\pagestyle{fancy}\n\\fancyhf{}\n\\renewcommand{\\headrulewidth}{0pt}\n\\renewcommand{\\footrulewidth}{0pt}\n\n\\addtolength{\\oddsidemargin}{-0.6in}\n\\addtolength{\\textwidth}{1.2in}\n\\addtolength{\\topmargin}{-0.7in}\n\\addtolength{\\textheight}{1.4in}\n\n\\raggedright\n\\raggedbottom\n\\setlength{\\parindent}{0pt}\n\n\\titleformat{\\section}{\n  \\vspace{-4pt}\\raggedright\\large\\bfseries\\uppercase\n}{}{0em}{}[\\titlerule \\vspace{-4pt}]\n\n\\pdfgentounicode=1\n\n\\newcommand{\\resumeSubheading}[2]{\n  \\begin{tabular*}{0.97\\textwidth}{l@{\\extracolsep{\\fill}}r}\n    \\textbf{#1} & #2 \\\\\n  \\end{tabular*}\n}\n\n\\newcommand{\\name}{Your Name}\n\\newcommand{\\phone}{1234567890}\n\\newcommand{\\email}{your.email@example.com}\n\n\\begin{document}\n\n\\begin{tabularx}{\\linewidth}{X r}\n\\begin{tabular}{@{}l@{}}\n{\\huge \\textbf{\\name}} \\\\\n{\\small Professional Role}\n\\end{tabular}\n&\n\\begin{tabular}{@{}r@{}}\nCity, India \\\\\n\\href{mailto:\\email}{\\email} \\\\\n+91-\\phone \\\\\n\\href{https://linkedin.com/in/profile}{LinkedIn}\n\\end{tabular}\n\\end{tabularx}\n\\vspace{-12pt}\n\n\\section{Professional Summary}\nHighly motivated professional with experience in building scalable solutions. Focus on performance and reliability.\n\n\\section{Education}\n\\resumeSubheading\n{Bachelor of Technology (B.Tech) — Your University}{2020 -- 2024} \\\\\n\n\\section{Professional Experience}\n\\resumeSubheading{Role — Company Name}{Date Range}\n\\begin{itemize}[itemsep=-1pt, topsep=0pt]\n  \\item Point one of your achievement.\n  \\item Point two of your impact.\n\\end{itemize}\n\n\\section{Project}\n\\resumeSubheading{Project Title}{Date}\n\\begin{itemize}[itemsep=-1pt, topsep=0pt]\n  \\item Key detail about what you built.\n\\end{itemize}\n\n\\section{Skills}\n\\begin{itemize}[itemsep=-1pt, topsep=0pt]\n  \\item \\textbf{Technical:} Python, Java, Docker\n\\end{itemize}\n\n\\end{document}`;
                    if(t === 'ats') this.latexCode = `\\documentclass[letterpaper,10pt]{article}\n\\newcommand{\\name}{ATS User}\n\\section{Summary}\nATS friendly resume focus...\n\\section{Experience}\nBuilt scalable systems.\n\\end{document}`;
