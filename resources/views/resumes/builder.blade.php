    ...
    <script>
        function resumeBuilder() {
            return {
                ...
                roleTemplates: @json($roleTemplates), newSkill: '', resume: @json($initialData), latexCode: @json($defaultLatex),
                init() { this.resume.template_id = 'ats-clean'; setTimeout(() => this.recompile(), 500); },
                ...
                recompile() {
                    ...
                    if (code.match(/LinkedIn/)) html += `<p><a href="#" class="text-blue-700 underline">LinkedIn</a></p>`;
                    html += `</div></div>`;
                    ...
                    if (sections) {
                        sections.forEach(sec => {
                            ...
                            // Subheadings Fix (Flexible spacing)
