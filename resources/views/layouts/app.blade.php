                ...
                <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
                    @php
                        $links = [
                            ...
                            ['label' => 'Academic Hub', 'route' => 'guides.index', 'icon' => 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253'],
                            ...
                            ['label' => 'AI Interview', 'route' => 'interview.index', 'icon' => 'M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z'],
...
@endforeach
            ...
            <div class="flex-1 flex flex-col min-w-0 bg-surface overflow-hidden">
                ...
                <!-- Page Content -->
                <main class="flex-1 overflow-y-auto px-0 md:px-8 py-8 md:pb-8 pb-32 page-fade-in">
                    @if(session('success'))
                            ...
                            <div class="grid grid-cols-2 lg:grid-cols-4 gap-12 mb-12 text-left">
                                ...
                                <div>
                                    ...
                                    <ul class="space-y-3 text-[10px] font-black uppercase tracking-widest text-slate-400">
                                        <li><a href="{{ route('guides.index') }}" class="text-primary hover:text-primary transition-colors">Academic Hub (New)</a></li>
