...
class NoteController extends Controller
{
    ...
    {
        $note = Note::with(['college', 'user', 'subject'])->findOrFail($id);
        ...
        $seoDescription = "Access high-fidelity academic notes for {$note->subject->name} at {$note->college->name}. Shared by {$note->user->name} in the MyCollegeVerse multiverse.";
